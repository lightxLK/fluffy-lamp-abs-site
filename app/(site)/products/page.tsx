  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="bg-bg-dark pb-24">
        <Container>
          {/* 7 products in a 3-col grid leaves the last row with 1 card — center it.
              Assumes PRODUCTS.length % 3 === 1; revisit this rule if that changes. */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 [&>*:last-child]:lg:col-start-2">
