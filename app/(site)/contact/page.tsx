              ...
              <div>
                ...
                <div className="flex gap-3">
                  ...
                  <a
                    ...
                    className="text-text-body text-sm leading-relaxed hover:text-text-primary transition-colors duration-200"
                  >
              ...
              <div>
                ...
                <div className="space-y-3">
                  <a
                    ...
                    className="flex items-center gap-3 text-text-body text-sm hover:text-text-primary transition-colors duration-200"
                  >
