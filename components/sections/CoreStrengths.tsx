...
const STRENGTHS = [
  ...
  },
  {
    number: '03',
    title: 'Engineering',
    body: "A 1,00,000 sq. ft. Jangalpur facility with integrated automation, positioned near Kolkata's industrial corridor for fast port, highway, and rail access.",
  },
  {
    number: '04',
    title: 'Finish',
