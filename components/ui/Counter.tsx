...
function Digit({ place, value, height, digitStyle }: DigitProps) {
  // Numeric place is 0 for the decimal-point placeholder so the hooks below
  // still run unconditionally (rules-of-hooks) — their result is just unused
  // when rendering the "." span.
