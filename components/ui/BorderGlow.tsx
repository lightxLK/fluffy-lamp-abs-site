...
export default function BorderGlow({
  ...
  useEffect(() => {
    ...
    // Deferred via rAF (an external-timer callback, not a synchronous effect-body
    // setState) so this satisfies react-hooks/set-state-in-effect.
  ...
  return (
    <div
      ...
      className={`relative z-[2] grid isolate border border-border-subtle light:!shadow-none ${className}`}
      style={{
    ...
    >
      ...
      <div className="flex flex-col relative overflow-hidden z-[1] h-full">{children}</div>
    </div>
  );
}
